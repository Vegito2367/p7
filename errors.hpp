#ifndef LEVI_ERRORS_H
#define LEVI_ERRORS_H
...
class RemovedError{
public:
	RemovedError(std::string msgIn) : myMsg(msgIn){}
	std::string msg(){ return "Removed from the language spec: " 
	+ myMsg + " no longer valid"; }
private:
	std::string myMsg;
};
