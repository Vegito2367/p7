...
class Label {
public:
  Label(std::string nameIn) { this->name = nameIn; }
...
public:
  ...
  virtual std::string locString() override { return mySym->getName(); }
  virtual std::string getName() { return mySym->getName(); }
...
public:
  AuxOpd(std::string nameIn, size_t width) : Opd(width), name(nameIn) {}
  virtual std::string valString() override { return "[" + getName() + "]"; }
  virtual std::string locString() override { return getName(); }
  std::string getName() { return name; }
  virtual void genLoadVal(std::ostream &out, Register reg) override;
  virtual void genStoreVal(std::ostream &out, Register reg) override;
  virtual void genLoadAddr(std::ostream &out, Register reg) override;
...
public:
  CallQuad(SemSymbol *calleeIn, int numArgsIn);
  std::string repr() override;
  void codegenX64(std::ostream &out) override;
...
public:
  GetArgQuad(size_t indexIn, Opd *opdIn, size_t numArgsIn);
  std::string repr() override;
  void codegenX64(std::ostream &out) override;
